...
public class CameraSwitcher : Singleton<CameraSwitcher>
{
    ...
    [SerializeField,Header("StateCameraInfoList")] private List<CharacterStateCameraInfo> stateCameraInfoList = new List<CharacterStateCameraInfo>();
    ...
    private void InitSwitchCamera()
    {
        ...
        {
            if (stateCameraInfoList[i].stateCameraList.Count == 0) { continue; }
