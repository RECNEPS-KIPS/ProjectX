...
//             ZZZZTimerManager.MainInstance.GetOneTimer(applyNextSwitchTime, ApplyNextSwitch);
//         }
...
//         {
//             SwitchCharacterInfo currentCharacterInfo = switchCharacterInfos.Find(i => i.characterName == currentCharacterName);//���б���ĳ��Ԫ�����ҵ����б���
