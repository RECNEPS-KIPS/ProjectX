...
namespace Framework.Common {
    ...
    public static class CommonUtils {
        ...
        public static Color GetRandomColor(bool isAlphaRandom = false) {
            var tempColorVec = new Vector3(new System.Random().Next(255), new System.Random().Next(255), new System.Random().Next(255)) / 255;
            return new Color(tempColorVec.x, tempColorVec.y, tempColorVec.z, isAlphaRandom ? (float)new System.Random().Next() / 255 : 1);
        }
