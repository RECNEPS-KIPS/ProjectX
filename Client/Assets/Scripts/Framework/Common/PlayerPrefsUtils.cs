...
namespace Framework.Common {
    ...
    public static class PlayerPrefsUtility {
        private static readonly byte[] SecretKey = { 217, 134, 151, 168, 185, 202, 129, 135, 150, 130, 141, 201, 210, 167, 198, 169 };
        /// <summary>
        /// 是否加密
        /// </summary>
        ...
        public static string GetString(string key, string defaultValue = "") {
            if (HasKey(key)) return IsEncrypt ? Decrypt(PlayerPrefs.GetString(key)) : PlayerPrefs.GetString(key, defaultValue);
            LogManager.LogWarning(LOGTag, $"The key {key} does not exist  ");
            return defaultValue;
        }
