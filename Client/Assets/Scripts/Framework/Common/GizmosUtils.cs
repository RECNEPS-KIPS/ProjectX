...
namespace Framework.Common
{
    public static class GizmosUtils
    {
        ...
        {
            DrawProjection(camera, new Vector3(-1, -1, -1), new Vector3(1, -1, -1), new Vector3(1, -1, 1), new Vector3(-1, -1, 1), new Vector3(-1, 1, -1), new Vector3(1, 1, -1), new Vector3(1, 1, 1), new Vector3(-1, 1, 1), color);
        }
        public static void DrawViewFrustumEx(Camera camera, float leftex, float rightex, float downex, float upex, Color color)
        {
            DrawProjection(camera, new Vector3(-1 + leftex, -1 + downex, -1), new Vector3(1 + rightex, -1 + downex, -1), new Vector3(1 + rightex, -1 + downex, 1), new Vector3(-1 + leftex, -1 + downex, 1), new Vector3(-1 + leftex, 1 + upex, -1), new Vector3(1 + rightex, 1 + upex, -1), new Vector3(1 + rightex, 1 + upex, 1), new Vector3(-1 + leftex, 1 + upex, 1), color);
        }
        private static void DrawProjection(Camera camera, Vector3 pj1, Vector3 pj2, Vector3 pj3, Vector3 pj4, Vector3 pj5, Vector3 pj6, Vector3 pj7, Vector3 pj8, Color color)
        {
