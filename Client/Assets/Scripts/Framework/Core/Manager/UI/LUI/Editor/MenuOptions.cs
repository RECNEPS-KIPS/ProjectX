...
namespace Framework.Core.Manager.UI
{
    ...
    public class MenuOptions
    {
        ...
        private static void SetPositionVisibleInSceneView(RectTransform canvasRectTransform,
            RectTransform itemTransform)
        {
            ...
            if (RectTransformUtility.ScreenPointToLocalPointInRectangle(canvasRectTransform,
                    new Vector2(camera.pixelWidth / 2f, camera.pixelHeight / 2f), camera, out var localPlanePosition))
            {
                ...
                minLocalPosition.x = sizeDelta.x * (0 - canvasRectTransform.pivot.x) +
                                     itemTransform.sizeDelta.x * itemTransform.pivot.x;
                minLocalPosition.y = canvasRectTransform.sizeDelta.y * (0 - canvasRectTransform.pivot.y) +
                                     itemTransform.sizeDelta.y * itemTransform.pivot.y;
                Vector3 maxLocalPosition;
                maxLocalPosition.x = canvasRectTransform.sizeDelta.x * (1 - canvasRectTransform.pivot.x) -
                                     itemTransform.sizeDelta.x * itemTransform.pivot.x;
                maxLocalPosition.y = canvasRectTransform.sizeDelta.y * (1 - canvasRectTransform.pivot.y) -
                                     itemTransform.sizeDelta.y * itemTransform.pivot.y;
