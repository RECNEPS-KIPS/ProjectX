...
namespace UI {
    public class ExampleUI : BaseWindow {
        public override void OnInit() {
            ...
            VBind("profession1");
            VBind("profession2");
            VBind("profession3");/*MBind("onDe",() => LogManager.Log("onLast"));*/VBind("profession4");//VBind("profession4");
            
            // DOBind<string>("profession8");
            // DOBind<UnityAction>("closeBtn11",() => {
        ...
        public override void OnEnter(dynamic args) {
            ...
            // Bind("modelPath","Assets/ResourceAssets/Character/pre_liam.prefab");
        }
    }
}