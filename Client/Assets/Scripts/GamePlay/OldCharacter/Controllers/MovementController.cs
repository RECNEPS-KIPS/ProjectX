...
//             {
//                 _velocity += tr.right * InputManager.Instance.GetMoveInput().x;
//                 _velocity += tr.forward * InputManager.Instance.GetMoveInput().y;
//             }
//             else
//             {
//                 //If a camera transform has been assigned, use the assigned transform's axes for movement direction;
//                 //Project movement direction so movement stays parallel to the ground;
//                 _velocity += Vector3.ProjectOnPlane(cameraTransform.right, tr.up).normalized * InputManager.Instance.GetMoveInput().x;
//                 _velocity += Vector3.ProjectOnPlane(cameraTransform.forward, tr.up).normalized * InputManager.Instance.GetMoveInput().y;
//             }
//
...
//         }
//
//         private const string LOGTag = "MovementController";
...
//                 {
//                     LogManager.Log(LOGTag,"HandleJumping");
//                     //Call events;
//                     OnGroundContactLost();
//                     OnJumpStart();
//
